...
//    private static List<BaseItem> mMenu = new ArrayList<>();
    ...
    public static List<BaseItem> getInitialItems() {
        ...
        rootMenu.add(new Item("Doctor Home"));
        rootMenu.add(new Item("Schedule Time"));
        rootMenu.add(new Item("Schedules"));
        rootMenu.add(new Item("Consultations"));
        rootMenu.add(new Item("Credentials"));
        rootMenu.add(new Item("Portfolio"));
        rootMenu.add(new Item("Earnings"));
        rootMenu.add(new Item("Reviews"));
