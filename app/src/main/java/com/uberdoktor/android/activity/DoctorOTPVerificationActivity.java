...
public class DoctorOTPVerificationActivity extends AppCompatActivity {
                ...
                call.enqueue(new Callback<RegisterResponse>() {
                    ...
                    public void onResponse(@NotNull Call<RegisterResponse> call, @NotNull Response<RegisterResponse> response) {
                        ...
                        if (response.isSuccessful()) {
                            startActivity(new Intent(DoctorOTPVerificationActivity.this, DoctorPasswordActivity.class));
                            finish();
                        }
                    }
                    ...
                    public void onFailure(@NotNull Call<RegisterResponse> call, @NotNull Throwable t) {
                        Toast.makeText(DoctorOTPVerificationActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
