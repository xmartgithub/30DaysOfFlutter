    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signUpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String confirmPassword = Objects.requireNonNull(confirmSignUpPassword.getEditText()).getText().toString().trim();
                ...
                if (!confirmPassword.equals(password)) {
                    Toast.makeText(DoctorPasswordActivity.this, "Password and confirm password should be same", Toast.LENGTH_SHORT).show();
                }


                Call<RegisterResponse> call = RetrofitClient.getInstance().getMyInterface().doctorRegistration("Bearer " + sharedPrefManager.getAccessToken(), password, confirmPassword);
                call.enqueue(new Callback<RegisterResponse>() {
                    ...
                    public void onResponse(@NotNull Call<RegisterResponse> call, @NotNull Response<RegisterResponse> response) {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            startActivity(new Intent(DoctorPasswordActivity.this, DoctorProfileDetailsActivity.class));
                            finish();
                        }
                    }
                    ...
                    public void onFailure(@NotNull Call<RegisterResponse> call, @NotNull Throwable t) {
                        Toast.makeText(DoctorPasswordActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
